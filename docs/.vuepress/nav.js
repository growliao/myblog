        ...
        items:[
            {
                ...
                items:[
                    ...
                    {text:'YAML<->Properites',link:'https://www.toyaml.com/index.html'},
            ...
            },
            {
                ...
                items:[
                    ...
                    {text:'tlddr 命令手册',link:'https://tldr.ostera.io/'},
                ]
            },
            {
                text:'开源镜像',
                items:[
                    {text:'OPSX',link:'https://developer.aliyun.com/mirror/'},
            ...
            },
            {
                ...
                items:[
                    ...
                    {text:'百度流量研究院',link:'https://tongji.baidu.com/research/'},
                ]
            },
            {
                text: '在线服务',
